...
export const projects: Project[] = [
  ...
  },
  {
    slug: "flappy-bird",
    name: "Flappy Bird",
    tagline: "Flappy Bird clone in C++ — browser-playable with a click",
    domain: "Systems",
    period: "2022",
    stack: ["C++", "HTML5 Canvas", "Physics"],
    ...
    summary: "The infamous one-button game — original C++ console version, playable in the browser with click/tap/space to flap. Pipes, gravity, score.",
    problem: "A C++ exercise in real-time loops, collision detection and simple physics.",
    approach: [
      "Original C++ version handles the game loop, gravity and pipe generation.",
      "Web version uses the same physics model on HTML5 canvas.",
    ],
    highlights: [
      "Playable in the browser — click, tap or press Space.",
      "Pipe collision, scoring and restart.",
    ],
    metrics: [],
  },
  {
